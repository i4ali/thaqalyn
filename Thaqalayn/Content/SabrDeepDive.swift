...
//  Thaqalayn
//
//  Fixed content for the "Ṣabr" deep dive - a descent through the three stations
//  of the patient heart (al-Ṣabr / al-Riḍā / al-Nafs al-Muṭmaʾinna). Rendered by
...
extension DeepDive {
    static let sabr: DeepDive = DeepDive(
        ...
        estMinutes: 5,
        acts: [
            ActInfo(number: 1, ar: "الصَّبْر", tr: "al-Ṣabr", name: "The Enduring"),
            ActInfo(number: 2, ar: "الرِّضَا", tr: "al-Riḍā", name: "The Accepting"),
            ActInfo(number: 3, ar: "النَّفْس المُطْمَئِنَّة", tr: "al-Nafs al-Muṭmaʾinna", name: "The Soul at Peace"),
        ],
        sections: [
            // 01. Opening
            .open(
            ...
            // 08. Movement II - The Willing Son (al-Ṣāffāt 37:102, Ismāʿīl)
            .verse(
                act: 2,
                tag: "The Willing Son",
                surah: 37,
            ...
            // 09. Movement II - The Excellent Servant (Ṣād 38:44, Ayyūb)
            .verse(
                act: 2,
            ...
            // 11. Movement III - The Last Night (night before ʿĀshūrāʾ)
            .narration(
                act: 3,
                tag: "The Last Night",
            ...
            // 12. Movement III - The Last Prostration (Imam al-Ḥusayn)
            .climax(
                act: 3,
