...
extension DeepDive {
    static let yaqin: DeepDive = DeepDive(
        ...
        estMinutes: 5,
        acts: [
            ActInfo(number: 1, ar: "عِلْمُ الْيَقِين", tr: "'Ilm al-Yaqīn", name: LocalizedText(en: "The Knowing", ur: "جاننا", ar: "المعرفة")),
            ActInfo(number: 2, ar: "عَيْنُ الْيَقِين", tr: "'Ayn al-Yaqīn", name: LocalizedText(en: "The Witnessing", ur: "دیکھنا", ar: "المشاهدة")),
            ActInfo(number: 3, ar: "حَقُّ الْيَقِين", tr: "Ḥaqq al-Yaqīn", name: LocalizedText(en: "The Living", ur: "جینا", ar: "المعايشة")),
        ],
        sections: [
            // 01. Opening
            .open(
            ...
            // 04. Movement I - The Question (al-Takāthur 102:5)
            .verse(
            ...
            .verse(
                act: 1, tag: LocalizedText(en: "Ibrahīm Reasons His Way", ur: "ابراہیمؑ عقل سے راہ پاتے ہیں", ar: "إبراهيم عليه السلام يهتدي بالاستدلال"), surah: 6, ayah: 76,
            ...
            // 08. Movement II - Ibrahīm Asks to See (al-Baqarah 2:260)
            .verse(
                act: 2, tag: LocalizedText(en: "Ibrahīm Asks to See", ur: "ابراہیمؑ دیکھنے کی درخواست کرتے ہیں", ar: "إبراهيم عليه السلام يطلب أن يرى"), surah: 2, ayah: 260,
            ...
            // 09. Movement II - And Then He Sees (al-Anbiyāʾ 21:69)
            .verse(
                ...
                translation: LocalizedText(en: "We said: “O fire - be coolness and peace upon Ibrahīm.”", ur: "ہم نے فرمایا: “اے آگ! تو ابراہیمؑ پر ٹھنڈک اور سلامتی بن جا۔”", ar: ""),
            ...
            // 10. Movement II - The Mother of Mūsā (al-Qaṣaṣ 28:7)
            .verse(
                act: 2, tag: LocalizedText(en: "The Mother of Mūsā", ur: "موسیٰؑ کی والدہ", ar: "أمّ موسى عليه السلام"), surah: 28, ayah: 7,
            ...
            // 12. Movement III - The Morning of ʿĀshūrāʾ
            .narration(
                act: 3, tag: LocalizedText(en: "The Morning of ʿĀshūrāʾ", ur: "عاشورہ کی صبح", ar: "صباح عاشوراء"), source: LocalizedText(en: "Radiance at Karbalāʾ - narrated of Hilāl ibn Nāfiʿ", ur: "کربلا کی تابانی - ہلال بن نافع سے مروی", ar: "إشراقٌ في كربلاء - رُوي عن هلال بن نافع"),
                body: LocalizedText(en: "They said that as the arrows fell thicker upon them, the face of Ḥusayn only grew more luminous and calm - so much so that those who looked on were struck by its light.", ur: "کہا گیا ہے کہ جوں جوں تیر ان پر کثرت سے برستے گئے، امام حسینؑ کا چہرہ اور بھی روشن اور پرسکون ہوتا گیا - یہاں تک کہ دیکھنے والے اس کے نور سے مبہوت رہ گئے۔", ar: "قالوا إنه كلما اشتدّ وقعُ السهام عليهم، ازداد وجهُ الحسين عليه السلام إشراقاً وسكينةً - حتى إنّ مَن نظر إليه بُهر بنوره."),
            ...
            .climax(
                act: 3, tag: LocalizedText(en: "The Court", ur: "دربار", ar: "المجلس"), source: LocalizedText(en: "Sayyida Zaynab, in the court of Ibn Ziyād - Kufa", ur: "سیدہ زینبؑ، ابن زیاد کے دربار میں - کوفہ", ar: "السيدة زينب عليها السلام، في مجلس ابن زياد - الكوفة"),
                ...
                reflection: LocalizedText(en: "This is Ḥaqq al-Yaqīn - the truth of certainty. Not the absence of grief, but the certainty that sees the divine beauty through it.", ur: "یہی حق الیقین ہے - یقین کی حقیقت۔ یہ غم کی عدم موجودگی نہیں، بلکہ وہ یقین ہے جو غم کے اندر سے بھی الٰہی خوبصورتی کو دیکھ لیتا ہے۔", ar: "هذا هو حَقُّ اليَقِين. ليس غيابَ الحزن، بل اليقينُ الذي يرى الجمالَ الإلهي من خلاله.")
            ),
