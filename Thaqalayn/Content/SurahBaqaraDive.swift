...
//  Thaqalayn
//
//  Fixed content for the "Inside the Sūrah - al-Baqara" experience. Rendered by
...
//  slice - the story that names the sūrah (2:67-74) - read as a mirror, with Ibrāhīm's
//  submission (2:131) as the answering foil. Structure is TWO movements + a label-less
//  coda (the story has one natural hinge, the reveal at 2:72; Ibrāhīm is a foil, not a
...
//  narrations of the Ahl al-Bayt (Imam al-Ṣādiq, Imam al-Kāẓim - ʿalayhim al-salām).
//
...
extension DeepDive {
    static let surahBaqara: DeepDive = DeepDive(
        ...
        estMinutes: 11,
        acts: [
            ActInfo(number: 1, ar: "السُّؤَال", tr: "al-Suʾāl", name: "The Asking"),
            ActInfo(number: 2, ar: "الْآيَة", tr: "al-Āya", name: "The Sign"),
        ],
        sections: [
            .open(
...
#if DEBUG
#Preview("Sūrah al-Baqara experience") {
