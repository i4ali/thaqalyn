...
SHOTS = [
    ...
    ("3_tafsir", "03_tafsir",
     "Five layers of tafsir<br>on every verse.",
     "From Foundation to the Ahlul Bayt, <mark>switch perspective with a tap.</mark>"),
    ("4_duas", "04_dua",
    ...
    ("7_quiz", "07_quiz",
     "Test what you learned,<br>surah by surah.",
     "A quiz for every surah, <mark>each answer explained from the tafsir.</mark>"),
